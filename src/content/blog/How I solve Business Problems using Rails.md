...
The first step on the journey is to fully understand the problem you are trying to solve, know the how a process in being done and the Why, who determined that rule, why it was determined, better understanding will allow us to craft better solutions and decide which trade-off we should take.
